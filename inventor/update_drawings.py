...
for i in range(1, docs.Count+1):
    ...
    titleblock = None
    try:
        titleblock = doc.TitleBlockDefinitions.Item('MAP')
    except:
        print('Title block MAP not found in %s.' % filename)
...
print('\n\n')
for status in styles_status:
    print('{:24}\tStyle {} is out of date'.format(*status))
